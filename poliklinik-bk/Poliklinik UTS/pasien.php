...
<div class="table-responsive">
    <table class="table table-hover">
        ...
        <tbody>
            ...
            $result = mysqli_query(
                $mysqli,
                "SELECT * FROM pasien ORDER BY nama DESC"
            );
            $no = 1;
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-success rounded-pill px-3" href="index.php?page=pasien&id=<?php echo $data['id'] ?>">Ubah
                        </a>
                        <a class="btn btn-danger rounded-pill px-3" href="index.php?page=pasien&id=<?php echo $data['id'] ?>&aksi=hapus">Hapus
                        </a>
                    </td>
                </tr>
            <?php
